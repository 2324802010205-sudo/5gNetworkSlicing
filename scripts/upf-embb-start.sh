...
# Áp dụng QoS cho eMBB: bandwidth 100Mbps, delay 20ms
...
tc class add dev ogstun parent 1: classid 1:10 htb rate 100mbit ceil 100mbit
tc qdisc add dev ogstun parent 1:10 handle 10: netem delay 20ms
